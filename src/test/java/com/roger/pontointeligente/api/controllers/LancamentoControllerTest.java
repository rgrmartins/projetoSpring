...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws Exception{
		...
		BDDMockito.given(this.funcionarioService.buscaPorId(Mockito.anyLong())).willReturn(Optional.of(new Funcionario()));
	...
	public void testCadastrarLancamentoFuncionarioIdInvalido() throws Exception {
		BDDMockito.given(this.funcionarioService.buscaPorId(Mockito.anyLong())).willReturn(Optional.empty());
