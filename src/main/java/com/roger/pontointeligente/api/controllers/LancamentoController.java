...
import com.roger.pontointeligente.api.dtos.LancamentoDto;
...
import com.roger.pontointeligente.api.services.LancamentoService;
...
public class LancamentoController {
	...
	@PreAuthorize("hasAnyRole('ADMIN')") //Só quem é admin pode remover
	public ResponseEntity<Response<String>> remover(@PathVariable("id") Long id){
		...
		if (!lancamento.isPresent()) {
			...
			response.getErrors().add("Erro ao remover o lançamento. Registro não encontrado para o id:" + id);
			return ResponseEntity.badRequest().body(response);
		}
	...
	/**
	 * valida um funcionário, verificando se ele existe e se é válido no sistema
	 * 
	 * @param lancamentoDto
	 * @param result
	 */
